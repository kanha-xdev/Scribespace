      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="text-2xl font-bold mb-4">BlogMedium</div>
            <p className="text-gray-300 mb-6">
              A platform for sharing knowledge, stories, and ideas. Join our community of writers and readers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/write" className="text-gray-400 hover:text-white transition-colors" data-testid="link-footer-write">
                  Write
                </a>
              </li>
              <li>
                <a href="/" className="text-gray-400 hover:text-white transition-colors" data-testid="link-footer-read">
                  Read
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          ...
          <div className="mt-8 text-center text-gray-400">
            <p>&copy; 2024 BlogMedium. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
